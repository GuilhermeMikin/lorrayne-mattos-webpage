        ...
        <article className="section-card p-7 md:p-9">
          ...
          <ul className="mt-6 space-y-3 text-sm text-slate-700 dark:text-slate-300">
            {course?.modules.slice(0, 3).map((module) => (
              <li key={module} className="rounded-2xl border border-slate-200 bg-white/70 px-4 py-3 dark:border-slate-800 dark:bg-slate-950/40">
                {module}
              </li>
            ))}
          </ul>
          <Link
            href={getLocalePath(safeLocale, "course/lm")}
